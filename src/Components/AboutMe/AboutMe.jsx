...
const AboutMe = () => {
  ...
  return (
    <div className={`my-15 ${theme ==='light' ? 'text-black':'text-white'} `}>
        ...
        <div className="flex lg:flex-row flex-col-reverse  m-5 sm:m-16 sm:justify-between items-center   justify-center overflow-hidden ">
                        <div className={`${isVisible?'slide-right':'slide-right-reverser'}  basis-1/3 flex flex-col justify-center items-center flex-1 relative  -left-400 text-center `}>
            ...
            <div className={`${isVisible?'slide-left':'slide-left-reverse'} relative -right-400 `}>
